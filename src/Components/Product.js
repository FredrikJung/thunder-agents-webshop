...
import { ConstructionOutlined, PrecisionManufacturing } from "@mui/icons-material";
  ...
  return (
    <div className="product">
      ...
      <div className="product-input">
        ...
        <Button style={{backgroundColor: "black", width: 132}}variant="contained" value={product.id} onClick={onSubmit}>Add to cart ({productAmount})</Button>
      </div>
    </div>
  );
};
